 ...
 * Renders nothing at all while the chat is disabled (off by default —
 * see isIntakeChatEnabled()) rather than falling back to a plain link;
 * the button itself should not be visible until that feature ships.

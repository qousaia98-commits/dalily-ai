...
const CATEGORY_IDS = {
  plumbing: "c0000000-0000-4000-8000-000000000001",
  electrical: "c0000000-0000-4000-8000-000000000002",
  "auto-repair": "c0000000-0000-4000-8000-000000000005",
};
...
const PROVIDERS = [
  {
    ...
    category_id: CATEGORY_IDS.plumbing,
  ...
  },
  {
    ...
    category_id: CATEGORY_IDS.electrical,
    city_id: CITY_IDS.damascus,
    verification_status: "verified",
    trust_score: 94,
    rating_avg: 4.8,
  ...
  },
  {
    ...
    category_id: CATEGORY_IDS["auto-repair"],
    city_id: CITY_IDS.damascus,
    verification_status: "verified",
    trust_score: 93,
    rating_avg: 4.8,
